  ...
  return (
    <>
      <nav className="navbar">
        {/* Brand */}
        <NavLink to={user ? "/dashboard" : "/"} className="navbar-brand" onClick={closeMenu}>
          <BrandLogo size="md" />
        </NavLink>
        ...
        <ul className="navbar-links">
          {user ? (
            ...
            <>
              ...
              <li>
                <NavLink to="/login" className={({ isActive }) => (isActive ? 'active' : '')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  Sign In
                </NavLink>
              </li>
              <li>
                <NavLink to="/register" className="btn btn-primary btn-sm" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.4rem 1rem', color: 'var(--bg)' }}>
                  Register
                </NavLink>
              </li>
            </>
      ...
      <div className={`navbar-mobile ${menuOpen ? 'open' : ''}`}>
        ...
        {user ? (
          ...
          <>
            <NavLink to="/" onClick={closeMenu} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <Home size={20} /> Home
            </NavLink>
            <NavLink to="/login" onClick={closeMenu} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              Sign In
            </NavLink>
            <NavLink to="/register" onClick={closeMenu} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              Register
            </NavLink>
          </>
        )}
